...
【第三部分：正文】
总字数：600-800字左右，但这是总参考，不是各部分硬指标，整体行文逻辑一致，不要强行罗列提示词，锦上添花的低饱和度 emoji 分段点缀。
第一层：事件描述

要求：有逻辑的详细描述新闻事实。重点是让读者了解新闻始末，包括不限于：起因，经过，结果，进展，反转等。用一个问句或一个独特的观察视角来开头。
...
要求：结合新闻内容输出你的核心观点，要犀利但不偏激。为读者提供1-2个具有实操性的“思考工具”或“行动建议”。这是体现你“互联网闺蜜”价值的地方，要让读者觉得“学到了”或“被点醒了”。语气是“提醒”而非“说教”。
